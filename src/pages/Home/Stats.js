...
const Stats = () => {
    return (
        <section className="p-6 my-6 bg-gray-800 text-gray-100 mx-8 rounded-lg">
	<div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-3">
		<div className="flex justify-center p-4 space-x-4 rounded-lg md:space-x-6 bg-gray-900 text-gray-100">
